...
pub enum Command {
    ...
    List {
        ...
        #[arg(
            ...
            default_value_t = ZoneRecordDetailLevel::Summary,
        )]
...
impl Command {
    pub async fn run(&self, config_file_name: &str, zone: String) -> Result<(), ZoneError> {
        match self {
            Command::Disable => {
            ...
            Command::List {
                ...
                let cmd = match GetRecordsCmd::create(
                    config_file_name,
                    zone.clone(),
                    domain.clone(),
                    detail.clone(),
